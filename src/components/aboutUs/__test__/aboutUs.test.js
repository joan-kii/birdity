...
const paragraphOne = 'This is just a fake social network for bird lovers like exercise at The Odin Project. It is made using React, React Router, Material-UI, and Firebase. It also has a simple chat implemented and makes use of a bird tracking API.'
